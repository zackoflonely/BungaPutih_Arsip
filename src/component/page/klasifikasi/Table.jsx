  ...
  return (
    <div className="overflow-x-auto my-3 w-full">
      <Link to='/upload/klasifikasi'>
          <Button color="light" className="py-2 px-3 my-2 bg-blue-700 border-xl-black text-white hover:text-black hover:font-bold font-base"><FontAwesomeIcon className="mt-1" style={{ fontSize: '0.8em', marginRight:'3px' }} icon={faPlus} />Jenis Surat</Button>
      </Link>
