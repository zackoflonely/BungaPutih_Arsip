            ...
            <div className="w-[68%]">
                ...
                <div className="flex mb-3 w-full justify-between items-center border border-md rounded-md p-5">
                    <div className="text-left">
                        ...
                        <h2 className="text-3xl font-base">Desa Bunga Putih</h2>
                    </div>
                ...
                <Link to='/upload'>
                    <Button color="light" className="py-2 px-3 my-2 bg-blue-700 border-xl-black text-white hover:text-black hover:font-bold font-base"><FontAwesomeIcon className="mt-1" style={{ fontSize: '0.8em', marginRight:'3px' }} icon={faPlus} />Surat</Button>
                </Link>
                <TableData getKonten={getKonten.slice(0,10)}/>
                <TableKlasifikasi getKonten={getKlas.slice(0,5)}/>
                <div className="grid grid-cols-2 gap-2 text-left">
                    <div className="flex justify-start items-center border border-md rounded-md p-5">
                        {getAll.map((item,idx)=>(
                            <div key={idx}>
